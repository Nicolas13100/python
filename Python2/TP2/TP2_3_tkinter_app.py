...
def load_from_file():
    ...
    if nom_fichier:
        try:
            ...
            return [], f"Le fichier {nom_fichier} est introuvable."
        except ValueError:
            return [], "Erreur de format dans le fichier. Assurez-vous que les prix sont des nombres valides."
    return [], None

def calculer():
    """Calculer les statistiques et afficher les résultats."""
    global input_prix, output_text
    try:
